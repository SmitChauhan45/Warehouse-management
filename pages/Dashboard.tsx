  ...
  useEffect(() => {
    if (data?.warehouses) {
      ...
      const lowCapacityCount = warehouses.filter((warehouse: WarehouseType) => {
        ...
        return usagePercentage > 80; // Consider warehouses with >80% usage as low capacity
      }).length;
    ...
    <div>
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
          ...
          <div className="bg-gray-50 dark:bg-gray-700 px-5 py-3">
            <div className="text-sm">
              <Link to="/warehouses" className="font-medium text-blue-600 hover:text-blue-500 dark:text-blue-400">
                View all
              </Link>
            </div>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
          ...
          <div className="bg-gray-50 dark:bg-gray-700 px-5 py-3">
            <div className="text-sm">
              <Link to="/items" className="font-medium text-blue-600 hover:text-blue-500 dark:text-blue-400">
                View inventory
              </Link>
            </div>
          </div>

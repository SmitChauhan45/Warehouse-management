...
import { Filter, Package, Search, Warehouse, ArrowUpDown, Plus } from 'lucide-react'
import { GET_WAREHOUSES, GET_ITEMS } from '@/lib/graphql/queries'
        ...
        {isLoading ? (
          ...
          <div className="text-center py-10">
            ...
            {(user?.role === 'admin' || user?.role === 'staff') && selectedWarehouse !== 'all' && (
              <div className="mt-6">
                <Link href={`/warehouses/${selectedWarehouse}`}>
                  <Button 
                    variant="primary"
